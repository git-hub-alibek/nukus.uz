...
<html lang="en">
<head>
<title><?php echo lang('menu_investicion');?></title>
<meta charset="utf-8">
			...
			<div class="row">
				<div class="col">
					<div class="section_title text-center">
						<h2><?php echo lang('menu_investicion');?></h2>
						<div></div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="news_posts">
						...
						<!-- News Post -->
						<div class="news_post">
							<div class="post_title"><a href="#"><?php echo lang('investicion');?></a></div>
							<div class="post_meta">
								
							</div>
							<?php foreach($investicion as $n):?>
							<div class="row">
							<div class="col-lg-6 post_image">
							<img width='500' src="/uploads/<?php echo $n->img;?>"/>
							</div>
							<div class='col-lg-6'>
							<div class="post_text ">
