...
<div class="super_container">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
	...
	<div class="milestones">
		<div class="milestones_background parallax-window" data-parallax="scroll" data-image-src="assets/images/fact_background.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title text-center">
		...
		<div class="container">
			...
			<div class="row icon_box_container">
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="assets/images/service_1.svg" class="svg" ></div>
						<div class="icon_box_title">Our young people studying abroad</div>
						...
						<a href="assets/#" class="icon_box_more">Read More</a>
					</div>
				</div>
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="assets/images/service_2.svg" class="svg" alt="https://www.flaticon.com/authors/monkik"></div>
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="assets/images/service_3.svg" class="svg" alt="https://www.flaticon.com/authors/monkik"></div>
						...
						<div class="footer_latest_content">
							...
							<div class="footer_latest_item">
								...
								<div class="footer_latest_item_content">
									<div class="footer_latest_item_title"><a href="assets/news.html">Brazil Summer</a></div>
							...
							<div class="footer_latest_item">
								...
								<div class="footer_latest_item_content">
									<div class="footer_latest_item_title"><a href="assets/news.html">A perfect vacation</a></div>
									<div class="footer_latest_item_date">Jan 09, 2018</div>
								</div>
							</div>
				...
				<div class="col-lg-4 footer_col">
					<div class="tags footer_tags">
						...
						<ul class="tags_content d-flex flex-row flex-wrap align-items-start justify-content-start">
							<li class="tag"><a href="assets/#">travel</a></li>
							<li class="tag"><a href="assets/#">summer</a></li>
							<li class="tag"><a href="assets/#">cruise</a></li>
							<li class="tag"><a href="assets/#">beach</a></li>
							<li class="tag"><a href="assets/#">offer</a></li>
							<li class="tag"><a href="assets/#">vacation</a></li>
							<li class="tag"><a href="assets/#">trip</a></li>
							<li class="tag"><a href="assets/#">city break</a></li>
							<li class="tag"><a href="assets/#">adventure</a></li>
						</ul>
					</div>
				</div>
